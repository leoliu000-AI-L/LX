...
// Unified Token Cache (Shared with feishu-doc, feishu-card, feishu-sticker)
...
async function getTenantAccessToken(forceRefresh = false) {
  ...
  if (!config.app_id || !config.app_secret) {
    throw new Error("Missing app_id or app_secret. Please set FEISHU_APP_ID and FEISHU_APP_SECRET in .env or config.json.");
  }
