...
const APP_TOKEN = process.env.FEISHU_DOC_APP_TOKEN;
const TABLE_ID = process.env.FEISHU_DOC_TABLE_ID || 'tblLy7koY2VGXGmR';
if (!APP_TOKEN) { console.error('Error: FEISHU_DOC_APP_TOKEN not set'); process.exit(1); }
